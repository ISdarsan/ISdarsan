...
<details>
<summary><b>🏢 Tomatrix · AI Software Development Intern — Jun 2025</b></summary>
<br/>

> `Firebase` `Supabase` `Authentication` `Netlify` `Real-time DB`

- Built workshop registration app supporting **3+ concurrent event types** → cut manual effort by **40%**
- Configured end-to-end Firebase Auth across **2 production apps** — **zero auth failures**
- Deployed both apps on Netlify with **zero downtime**; reduced data inconsistency by **30%**

</details>

<details>
<summary><b>🏢 Cydez Technologies · Full Stack Intern — Dec 2024 – Jan 2025</b></summary>
<br/>

> `MongoDB` `Express.js` `React.js` `Node.js` `JWT` `REST APIs`

- Full MERN e-commerce with **8+ modules** → purchase flow **under 3 steps**
- Architected **10+ RESTful endpoints** with JWT + RBAC; improved MongoDB query perf by **25%**
- **20+ test cases** run → **defect-free release**

</details>

<details>
<summary><b>🏢 ICT Academy of Kerala · Cloud Intern — Jul–Aug 2023</b></summary>
<br/>

> `AWS EC2` `S3` `IAM` `Cloud Architecture`

- Deployed e-learning platform for **50+ concurrent learners** at **99% uptime**
- Documented **5+ config files** → reduced future setup time by **50%**
...
`Flutter` `Firebase` `Python` `AI Face Recognition` `GPS Geofencing`
> **Adani Vizhinjam Port CSR** · [📂 Repo](https://github.com/ISdarsan/lasher_workers_app)

| Metric | Impact |
|--------|--------|
| 👷 Workers managed | **100+** across 5+ remote sites |
| ⏱️ Onboarding time | 3 days → **under 1 hour (90%+ cut)** |
| 💰 Payroll effort | **80% workload reduction** |
| 🔐 Auth method | AI Face Recognition + GPS Geofencing |

---

### ⚡ Viz Energy — IoT Energy Monitoring + ML Forecasting
`IoT` `Python` `LSTM` `Machine Learning` `Firebase` `Flutter`
> **Adani Vizhinjam Port CSR** · [📂 Repo](https://github.com/ISdarsan/VIZ_ENERGY)

| Metric | Impact |
|--------|--------|
| 📡 IoT Sensors | **10+ sensors** live to Firebase |
| 🧠 ML Model | **LSTM** on **6+ months** historical data |
| 💡 Wastage Found | Supervisors caught **20%+ energy waste** |

---

### 🎓 ZoomTots — AI Educational Content Platform
`React.js` `Python` `Firebase` `MySQL` `TTS API`
> [📂 Repo](https://github.com/ISdarsan/cartoon-based-educational-website)

| Metric | Impact |
|--------|--------|
| 🎬 Pipeline | PPT → 4-stage animated video |
| ⏱️ Time saved | **60% reduction** in content creation |
| 📝 Assessment | MCQ module, **5+ question types** |

---

### 🍽️ Foodprint — Offline-first POS System
`Flutter` `Firebase` `Python` `REST APIs`
> **Adani Vizhinjam Port CSR** · [📂 Repo](https://github.com/ISdarsan/printing_app_adani)

| Metric | Impact |
|--------|--------|
| 🏪 Canteens | **3+ women-run community canteens** |
| 📦 Transactions | **100+ daily**, zero data loss offline |
